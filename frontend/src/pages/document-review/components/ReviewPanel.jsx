...
const ReviewPanel = ({ 
  ...
  // 🔹 Local UI state only (NOT related to role data)
  ...
  const [activeSection, setActiveSection] = useState(null); // Track which section is adding subtask
  ...
  // 🔹 Reset local UI state when role or task changes from parent
  useEffect(() => {
    ...
    // Reset UI state (comments, ratings, etc.)
    setCheckedItems({});
    setComments('');
    setOverallRating(0);
    setJustification('');
        ...
        <>
          ...
          <div className="p-4 border-t border-border space-y-4">
            ...
            {/* <Button
              ...
              disabled={!subtasks || subtasks.length === 0}
            >
