...
const DocumentReviewWorkflow = () => {
  ...
  const getReviewPriority = (doc) => {
    // Priority logic: documents with versions under review or new versions
    if (doc.under_review_versions > 0) return 'high';
    if (doc.total_versions > 1) return 'medium';
    return 'low';
  };
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-8">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Loading review workflow...</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="font-body text-lg text-muted-foreground">
                Manage document reviews and version control
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            {selectedProject ? (
              <div className="space-y-6">
                ...
                {/* Document Types with Review Actions */}
                {documentSummary.length > 0 ? (
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => handleDocumentTypeSelect(doc.document_type)}
                              iconName="Eye"
                              iconPosition="left"
                            >
                              Review Versions
              ...
              <div className="bg-card border border-border rounded-lg p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Choose a project from the left sidebar to review its documents
                </p>
              </div>
            )}
          </div>
      ...
      {showVersions && selectedProject && selectedDocumentType && (
        <DocumentVersions
      ...
      {showAuditTrail && selectedProject && (
        <DocumentAuditTrail
          landId={selectedProject.land_id}
          documentType={selectedDocumentType}
...
export default DocumentReviewWorkflow;
